 ...
 * time.</p>
 *
 * https://github.com/lucko/spark/blob/master/spark-common/src/main/java/me/lucko/spark/common/monitor/tick/SparkTickStatistics.java
 */
public class StcordTickStatistics implements TickHook.Callback, TickReporter.Callback, TickStatistics {
